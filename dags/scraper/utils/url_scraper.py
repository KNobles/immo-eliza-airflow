...
class Scraper:
    ...
    def write_property_urls(self):
        ...
        with get_context("fork").Pool() as pool:
            gen = list(tuple(pool.map(self._get_properties_url, range(1, 300))))
